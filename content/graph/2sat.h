 ...
 * Negated variables are represented by bit-inversions (\texttt{\xetilde{}x}).
 * Usage:
 *  TwoSat ts(number of boolean variables);
 *  ts.either(0, \xetilde3); // Var 0 is true or var 3 is false
 *  ts.set_value(2); // Var 2 is true
 *  ts.at_most_one({0,\xetilde1,2}); // <= 1 of vars 0, \xetilde1 and 2 are true
